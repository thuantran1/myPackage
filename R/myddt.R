#' Plots length vs weight for a species of fish, colored by river with a quadratic curve
#'
#' @param df dataframe of the ddt file
#' @param SPECIES only values from the species will be used
#'
#' @return plot of length vs weight for species
#'
#' @examples
#' \dontrun{
